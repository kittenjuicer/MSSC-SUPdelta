...
def generate_pocket_garden_layer(layer_id, num_points=9200, dpi=600):
    ...
    ax.text(px*0.06, px*0.93, 
            f'Garden LifeFlow\nLayer {layer_id+1}\nTower Depth {tower_level:.1f}', 
            fontsize=14, fontweight='bold', color='#f0e0b0', alpha=0.78, va='top', ha='left')
    
    filename = f'GardenLifeFlow_Pocket_Color_layer_{layer_id+1:02d}.png'
